...
$obtenerUsuarios = "SELECT u.name, u.email, u.phoneNumber, u.address, u.registrationDate, uv.status, uv.bank_account, b.routing_number_ach, b.routing_number_wire, b.bank_address, b.account_name
                   FROM users u
...
$obtenerUsuarios .= " ORDER BY u.registrationDate DESC";
