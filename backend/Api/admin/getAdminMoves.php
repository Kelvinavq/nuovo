...
try {
    ...
    $getTransactionsQuery = "
        SELECT 
            ...
            d.platform_type AS deposit_platform_type,
            d.note_amount_modified AS deposit_note_amount_modified,
            d.note_transaction_modified AS deposit_note_transaction_modified,
    ...
    $formattedTransactions = array_map(function ($transaction) {
        ...
        return array(
            ...
            'deposit' => array(
                ...
                'platform_type' => $transaction['deposit_platform_type'],
                ...
                'note_transaction_modified' => $transaction['deposit_note_transaction_modified'],
