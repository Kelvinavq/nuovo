...
import List_Balances from "../../components/Admin/Balances_users/List_Balances";
...
const Balances_Users = () => {
  ...
  return (
    <div className="balances_usuarios">
      <Sidebar_a />
      <Button_a />
      <Notification_a />
